...
| [Dialog view](../src/dialog/dialog-view.js) and [field renderer](../src/dialog/field-renderer.js)                                              | Construct the dialog shell, form, action buttons, and framework presentation; render and populate configured fields.          |
